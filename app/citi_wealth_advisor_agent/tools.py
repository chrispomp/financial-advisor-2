...
def get_client_profile() -> str:
    """
    Retrieves the comprehensive profile for the wealth management client, including
    personal details, financial data, goals, and relationship history. This is the
    single source of truth for all client-related information.
    """
    profile_data = {
